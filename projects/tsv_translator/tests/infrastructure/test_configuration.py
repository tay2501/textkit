...
class TestConfiguration:
    ...
    def test_configuration_validation_errors(self):
        ...
        with pytest.raises(
            ConfigurationError, match="preview_lines must be at least 1"
        ):
            Configuration(preview_lines=0)

        with pytest.raises(
            ConfigurationError, match="data_type_confidence_threshold must be between"
        ):
    ...
    def test_from_env(self):
        ...
        try:
            ...
            # Clean up
            for key in [
                "TSV_TRANSLATOR_DEFAULT_ENCODING",
                "TSV_TRANSLATOR_MAX_FILE_SIZE",
                "TSV_TRANSLATOR_ENABLE_CONSOLE_LOGGING",
                "TSV_TRANSLATOR_ENABLE_FILE_LOGGING",
    ...
    def test_to_dict(self):
        ...
        config = Configuration(
            default_encoding="utf-16", max_file_size=5000, log_level="DEBUG"
        )
    ...
    def test_update(self):
        ...
        updated_config = config.update(default_encoding="utf-16", max_file_size=5000)
