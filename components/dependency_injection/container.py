...
class Container:
    ...
    def configure_defaults(self) -> Container:
        ...
        try:
            ...
            from components.rule_parser.core import RuleParser

            # Register RuleParser as singleton
            ...
            self.register_singleton(
                ...
                lambda config_manager, rule_parser: TextTransformationEngine(
            ...
            try:
                from components.io_handler.manager import InputOutputManager
                self.register_singleton(
                    InputOutputManager,
