...
class TestInputOutputManager:
    ...
    def test_get_clipboard_text_unavailable(
    ...
    def test_get_input_text_no_input_available(
        self, io_manager, mock_clipboard_unavailable
    ):
    ...
    def test_safe_copy_to_clipboard_unavailable(
        self, io_manager, mock_clipboard_unavailable
    ):
    ...
    def test_emergency_output_stdout_fallback(self, io_manager):
        ...
        with (
            patch(
                "builtins.print", side_effect=[Exception("stderr error"), None]
            ) as mock_print,
            patch("sys.stdout.flush"),
        ):
            io_manager.emergency_output(test_text)
    ...
    def test_emergency_output_file_fallback(
        self, io_manager, mock_clipboard_unavailable
    ):
