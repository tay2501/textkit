...
class TestInputOutputManager:
    ...
    def mock_clipboard_available(self):
        ...
        with patch('text_processing.io_handler.core.CLIPBOARD_AVAILABLE', True):
            yield

    @pytest.fixture
    def mock_clipboard_unavailable(self):
        """Mock clipboard as unavailable."""
        with patch('text_processing.io_handler.core.CLIPBOARD_AVAILABLE', False):
            yield
