...
class TestEdgeCasesBasicTransformer:
    ...
    def test_unicode_support(self):
        ...
        unicode_text = "H├®ll├Č W├Črld ­¤īŹ"
        assert self.transformer.transform(unicode_text, "l") == "h├®ll├Č w├Črld ­¤īŹ"
        assert self.transformer.transform(unicode_text, "u") == "H├ēLL├üEW├¢RLD ­¤īŹ"
...
class TestEdgeCasesStringTransformer:
    ...
    def test_replace_special_regex_chars(self):
        ...
        text = "Price: $10.99"
        result = self.transformer.transform(text, "r", ["$", "Ōé¼"])
        assert result == "Price: Ōé¼10.99"
...
class TestEdgeCasesJsonTransformer:
    ...
    def test_json_with_unicode(self):
        ...
        unicode_json = '{"message":"H├®ll├Č W├Črld ­¤īŹ","emoji":"­¤üE"}'
        result = self.transformer.transform(unicode_json, "json")

        assert "H├®ll├Č W├Črld ­¤īŹ" in result
        assert "­¤üE" in result
